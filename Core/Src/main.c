...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, PILOT_Pin|TANKS_Pin|IGNITER_Pin|SPARE_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PILOT_Pin TANKS_Pin IGNITER_Pin SPARE_Pin */
  GPIO_InitStruct.Pin = PILOT_Pin|TANKS_Pin|IGNITER_Pin|SPARE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
